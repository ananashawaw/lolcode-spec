...
[KTHXBYE](lolcode-keywords-v1.0.md#KTHXBYE). We have an effectively
...
```
We've seen
[HAI](lolcode-keywords-v1.0.md#HAI), [KTHXBYE](lolcode-keywords-v1.0.md#KTHXBYE), 
[CAN HAS](lolcode-keywords-v1.0.md#CAN-HAS), and
[VISIBLE](lolcode-keywords-v1.0.md#VISIBLE) already in the listing for
[HAI WORLD](#HAI-WORLD).  We learn a bit about variables in this one.

- Declaration is handled with [I HAS A](lolcode-keywords-v1.0.md#I-HAS-A).
  The (dynamically typed) variable follows.
  - [IM IN YR](lolcode-keywords-v1.0.md#IM-IN-YR) and [IM OUTTA YR](lolcode-keywords-v1.0.md#IM-OUTTA-YR) clearly demarcate a loop construct.
  `LOOP` in this example is simply a label.
- [UP](lolcode-keywords-v1.0.md#Computational-Operators) is an increment
...
- The `IZ ... ?`  construct is the basic conditional form. In this
  ...
  [KTHXBYE](lolcode-keywords-v1.0.md#KTHXBYE) command, here used as a
  `BREAK`.
- [BIGGER THAN](lolcode-keywords-v1.0.md#Conditional-Operators) is a comparator.
...
- `PLZ ... ?` introduces a try/exception block.
  ...
  - `O NOES`, which is the exception block. It should be closed with
    [KTHX](lolcode-keywords-v1.0.md#KTHX), but it hits the final
    [KTHXBYE](lolcode-keywords-v1.0.md#KTHXBYE), which (I assert) is a
    bit of
...
KTHXBYE
```
[GIMMEH](lolcode-keywords-v1.0.md#GIMMEH) wins out over `TXT ME A` for inputting a line from the user.
...
[HAI](lolcode-keywords-v1.0.md#HAI) and [KTHXBYE](lolcode-keywords-v1.0.md#KTHXBYE) are the start and stop block delimiters.  
[CAN HAS](lolcode-keywords-v1.0.md#CAN-HAS) is a feature request, like `require` or `include`.  
[VISIBLE](lolcode-keywords-v1.0.md#VISIBLE) is a print statement.
...
KTHXBYE
```
See [IZ](lolcode-keywords-v1.0.md#IZ) for more details on the conditional statement.

And let's open up [BTW](lolcode-keywords-v1.0.md#BTW) as the comment form. I'm not closing the door on `^^`, but again, I want to minimize the amount of punctuation.
